...
const EditPage = () => {
    ...
    const updateProduct = async (e) => {
        ...
        setIsLoading(true);
        try {
            await axios.put(`http://localhost:3000/api/product/${id}`, product);
        ...
        <div className="max-w-lg bg-white shadow-lg mx-auto p-7 rounded mt-6">
            ...
            {isLoading?("Loading"):(
                ...
                <div className="space-y-2">
                    ...
                    <div>
                        {!isLoading && (<button className="block w-full mt-6 bg-blue-700 text-white rounded-sm px-4 py-2 font-bold hover:bg-blue-600 hover:cursor">Update</button>)}
